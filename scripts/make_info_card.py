...
# ===========================================================================
HOST = "shashwat"   # shown as  shashwat@github  in the header
...
ROWS = [
    ...
    ("gap",),
    ("sec", "Stack"),
    ("kv", "Languages", "Java, Python, SQL, JavaScript"),
    ("kv", "Web", "HTML5, CSS3, React.js, Next.js"),
    ("kv", "Backend", "MySQL, JDBC, REST APIs"),
    ("kv", "Tools", "Git, GitHub, VS Code, Agile"),
    ("gap",),
    ("sec", "Highlights"),
    ("bul", "Strong grasp of DSA, OOP & SDLC fundamentals"),
    ("bul", "Builds full-stack apps: REST APIs, DB design, CRUD"),
]
